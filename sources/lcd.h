...
/* struct de um numero do tipo float que deve ser lancada para a placa LCD */
typedef struct numero_tipo_float
{
	int iParteInteiro;
	int iParteDecimal;
...
/* Output params:	   n/a 							*/
/* ************************************************ */
void lcd_writeFloat(const char *cString, float fNumero, int iNumeroCasas, int iLinha, int iColuna);
